                ...
                <div class="card-body">
                  <div class="row">
                    <div class="col-lg-5 col-md-5 col-5">
                      <a href="{{url('/admin/assign-contacts')}}" class="btn btn-success" style="border-bottom: 5px solid #ff4081;padding: 8px;">Assigned Contact - <span>{{$count_assign}}</span></a>
                      <a href="{{url('/admin/unassign-contacts')}}" class="btn btn-success" style="padding: 10px;">Unassigned Contact - <span>{{$count_unassign}}</span></a>
                    </div>
                      ...
                      <tbody>
                        ...
                        @foreach($data as $datas)
                          <tr>
                            ...
                            <td>{{$datas->status}}</td>
                            <td>
                              <a href="{{url('/admin/assign-contacts/edit-'.$datas->id)}}"><i class="mdi mdi-table-edit"></i></a>
                              <a href="{{url('/admin/assign-contacts/delete-'.$datas->id)}}"><i class="mdi mdi-delete-forever"></i></a>
                            </td>
                          </tr>
                        @endforeach
                      </tbody>
