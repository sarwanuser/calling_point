...
@section('title', 'Admin - Create Contacts')
              ...
              <div class="card-body">
                <div class="row">
                  <div class="col-lg-6 col-md-6 col-6">
                    <h4 class="card-title">Create Contacts</h4>
                  </div>
                  ...
                  <div class="row">
                    ...
                    <div class="col-md-6">
                      <div class="form-group row">
                        ...
                        <div class="col-sm-9">
                          <textarea type="text" class="form-control" name="location" style="height:50px;"></textarea>
                        </div>
                      </div>
                    </div>
                    ...
                    <div class="col-md-6">
                      <div class="form-group row">
                        ...
                        <div class="col-sm-9">
                          <textarea type="text" class="form-control" name="additional_info" style="height:50px;"></textarea>
                        </div>
                      </div>
                    </div>
