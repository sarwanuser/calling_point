...
@section('title', 'Spoker - All Future Follow Up Contacts')
                ...
                <div class="card-body">
                  <div class="row">
                    <div class="col-lg-12 col-md-12 col-12">
                      ...
                      <a href="{{url('/today-followup-contacts')}}" class="btn btn-success" style="padding: 10px;">Today Follow Up - <span id="today_id">{{@getFollowupContact('today')}}</span></a>
                      <a href="{{url('/future-followup-contacts')}}" class="btn btn-success" style="border-bottom: 5px solid #ff4081;padding: 8px;">Future Follow Up - <span id="future_id">{{@getFollowupContact('future')}}</span></a>
                    </div>
                  </div>
                  <div class="row">
                    <div class="col-lg-12 col-md-12 col-12">
                  ...
                  <div class="container">
                    <div id="myCarousel" class="carousel slide" data-ride="carousel" data-pause="hover">
                      ...
                      <div class="carousel-inner">
                        ...
                        @else
                          <div style="color:red;text-align:center;">Future Follow Up Contact Not Found.</div>
                        @endif
                      </div>
