...
@section('title', 'Spoker - All Past Follow Up Contacts')
                ...
                <div class="card-body">
                  <div class="row">
                    <div class="col-lg-12 col-md-12 col-12">
                      ...
                      <a href="{{url('/past-followup-contacts')}}" class="btn btn-success" style="border-bottom: 5px solid #ff4081;padding: 8px;">Past Follow Up - <span id="past_id">{{@getFollowupContact('past')}}</span></a>
                  ...
                  <div class="container">
                    <div id="myCarousel" class="carousel slide" data-ride="carousel" data-pause="hover">
                      ...
                      <div class="carousel-inner">
                        ...
                        @else
                          <div style="color:red;text-align:center;">Past Follow Up Contact Not Found.</div>
                        @endif
                      </div>
