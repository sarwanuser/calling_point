...
@section('title', 'Spoker - All Do Not Call Contact')
                ...
                <div class="card-body">
                  <div class="row">
                    <div class="col-lg-5 col-md-5 col-5">
                      <h4 class="card-title">All Do Not Call Contacts</h4>
                    </div>
                  ...
                  <br>
                  <form class="form-sample" action="{{url('/donot-call-contacts')}}" method="get">
                    @csrf
                    <div class="row">
                      <div class="col-md-5">
                      ...
                      <div class="col-md-2">
                        ...
                        <a href="{{url('/donot-call-contacts')}}" class="btn btn-warning" style="padding:8px;">Reset</a>
                      </div>
                  </form>
